      ...
      <transition name="fade">
        <template v-if="!isLoading && preset">
          <div class="w-full h-full flex flex-col gap-6">
            <div v-if="preset.images.length" class="flex flex-col xl:flex-row gap-4">
              <NuxtImg class="w-full xl:w-72 xl:h-40 rounded-md" v-for="img in preset.images" :key="img" :src="img" placeholder />
            </div>
            <div>
